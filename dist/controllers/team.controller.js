...
tslib_1.__decorate([
    rest_1.post('/teams', {
        responses: {
            '200': {
                ...
                content: { 'application/json': { schema: rest_1.getModelSchemaRef(models_1.Team) } },
            },
        },
    }),
    tslib_1.__param(0, rest_1.requestBody({
        content: {
            'application/json': {
                schema: rest_1.getModelSchemaRef(models_1.Team, {
                    title: 'NewTeam',
                    exclude: ['id'],
                }),
            },
            ...
            '200': {
                ...
                content: {
                    'application/json': {
                        schema: {
                            type: 'array',
                            items: rest_1.getModelSchemaRef(models_1.Team, { includeRelations: true }),
                        },
                    },
                },
            },
...
tslib_1.__decorate([
    ...
    tslib_1.__param(0, rest_1.requestBody({
        content: {
            'application/json': {
                schema: rest_1.getModelSchemaRef(models_1.Team, { partial: true }),
            },
        },
    })),
    ...
    rest_1.get('/teams/{id}', {
        responses: {
            '200': {
                ...
                content: {
                    'application/json': {
                        schema: rest_1.getModelSchemaRef(models_1.Team, { includeRelations: true }),
                    },
                },
            },
        },
...
TeamController = tslib_1.__decorate([
    tslib_1.__param(0, repository_1.repository(repositories_1.TeamRepository)),
